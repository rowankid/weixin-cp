package cn.luowq.wx.cp.config;

import java.util.Map;
import java.util.stream.Collectors;

import cn.luowq.wx.cp.handler.ContactChangeHandler;
import cn.luowq.wx.cp.handler.EnterAgentHandler;
import cn.luowq.wx.cp.handler.SubscribeHandler;
import cn.luowq.wx.cp.handler.UnsubscribeHandler;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.boot.context.properties.EnableConfigurationProperties;
import org.springframework.context.annotation.Bean;
import org.springframework.context.annotation.Configuration;

import cn.luowq.wx.cp.handler.LocationHandler;
import cn.luowq.wx.cp.handler.LogHandler;
import cn.luowq.wx.cp.handler.MenuHandler;
import cn.luowq.wx.cp.handler.MsgHandler;
import cn.luowq.wx.cp.handler.NullHandler;
